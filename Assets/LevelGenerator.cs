    ...
    private void Update()
    {
        ...
        if(transform.position.x >= Index)
        {
            ...
            if(RandomInt1 == 1)
            {
                ...
                //TempTile1.transform.position = new Vector3(-2, 0, 0);
            }
            else if(RandomInt1 == 0)
            {
                //GameObject TempTile2 = Instantiate(Tile2, transform);
                //TempTile2.transform.position = new Vector3(-40, 0, 0);
            }
            ...
            {
                GameObject TempTile1 = Instantiate(Tile1, transform);
                TempTile1.transform.position = new Vector3(-5, 0, 0);
            }
            else if(RandomInt2 == 0)
            {
                GameObject TempTile2 = Instantiate(Tile2, transform);
                TempTile2.transform.position = new Vector3(-50, 0, 0);
            }
